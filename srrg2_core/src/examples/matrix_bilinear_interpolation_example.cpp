...
int main (int argc, char ** argv) {
  ...
  std::cerr << "interpolated_point.coordinates" << interpolated_point.coordinates().transpose() << std::endl;
  ...
  std::cerr << "interpolated_point.normal" << interpolated_point.normal().transpose() << std::endl << std::endl;
