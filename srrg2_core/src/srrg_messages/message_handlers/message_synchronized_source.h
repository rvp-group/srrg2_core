...
namespace srrg2_core {
  ...
  public:
      ...
      PARAM(PropertyString, output_frame_id, "name of the frame in the message pack", "pack_frame_id", 0);
      PARAM_VECTOR(PropertyVector_<std::string>, topics, "topics to synchronize",  &_topics_changed);
      PARAM(PropertyDouble, time_interval, "interval for the messages to be sinchronized", 0.1, &_interval_changed);
  public:
