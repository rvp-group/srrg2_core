...
using UnprojectorType=PointUnprojectorPolar_<MyPointWithNormal3fCloud>;
using ProjectorType = PointProjectorPolar_<MyPointWithNormal3fCloud>;
static constexpr TRANSFORM_CLASS projection_class=PolarProjection;
static constexpr TRANSFORM_CLASS unprojection_class=PolarUnprojection;
