...
int main(int argc, char** argv) {
  ...
  ros::Publisher publisher_marker = nh.advertise<visualization_msgs::Marker>(PUB_NAME, PUB_QUEUE_SIZE); //ia publisher name, queue size

  signal(SIGINT, sigIntHandler);

  //ia create some points
  PointNormal3fVector pointcloud(POINTS_BULK_SIZE);
